...
#define AP_NAME "QQC_GW_0001"  //热点模式下设备生成的网络名
#define AP_PASSWORD "qiaqiacloud818"  //热点模式下连接该网络密码

//extern char AP_NAME[50];  //可变热点名时使用
//extern char AP_PASSWORD[];

//#define AP_NAME "energia"  //热点模式下设备生成的网络名
//#define AP_PASSWORD "launchpad"  //热点模式下连接该网络密码


//设备上按键定义，仅适用于TI CC3200-LAUNCHXL开发板
//其它设备根据情况再自行设定
#define button_SW2  PUSH2
#define ledPin  GREEN_LED


//程序release版本和debug版本设定开关
...
private:
	...
	String _valuechangepayload[1];   //有待修改
