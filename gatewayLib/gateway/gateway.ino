...
// input WiFi SSID and passcode of the router which you want to connect to
//char ssid[] = "qiaqiacloud"; //"CU_jTpb";
//char password[] = "zhanggaoyuan20090406"; //"n5w696xq";
...
{
  Serial.begin(115200);
  //qiaqia.gwInit("585115b145f50810c839d1f3", "57fb3f58d8207e1934bb2e88", "101.201.78.22");
  qiaqia.gwInit();
...
void loop()
{
    qiaqia.gwRun();
         ...
         if((millis() - onlineConfigStart) < 0){
              Serial.println("millis() runoff");  //按下时正赶上溢出
              onlineFirstTimeState = 1;  //下次重新标记按下时刻
         }
         ...
         /*
          delay(500);
              ...
              qiaqia.online(2, 3, true);
              delay(500);
              qiaqia.gwValueChange(2, 1, 1, "1.6");
              qiaqia.gwValueChange(2, 2, 1, "2.6");
              qiaqia.gwValueChange(2, 3, 1, "3.6");
